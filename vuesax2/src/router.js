...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                {
                    path: '/apps/emailrefactory',
                    name: 'emailrefactory',
                    component: () => import('./views/myapp/email/EmailRefactory.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Data List'},
                ...
                {
                    path: '/apps/chatrefactory',
                    name: 'chatrefactory',
                    component: () => import('./views/myapp/chat/Chat.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/apps/uploadrefactory',
                    name: 'uploadrefactory',
                    component: () => import('./views/myapp/upload/Upload.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/apps/showrefactory',
                    name: 'showrefactory',
                    component: () => import('./views/myapp/showfile/show.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/apps/crudrefactory',
                    name: 'crudrefactory',
                    component: () => import('./views/myapp/crud/crud.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
